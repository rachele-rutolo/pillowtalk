...
PT.CATALOGO = {
  "articulo-orgasmo":        { titulo: "El orgasmo no es la meta (y se nota cuando lo es)", meta: "artículo · 6 min", tipo: "articulo", pantalla: "contenido-articulo", img: "assets/imagen1_panel_5_mejorado.png",
                               autor: "Autor", autoria: { nombre: "Nombre de la autora", rol: "Sexóloga · colegiada nº 0000" },
                               cuerpo: ["Qué pasa cuando todo el encuentro se organiza alrededor de un final obligatorio, y cómo se desmonta ese guion sin perder nada por el camino.",
                                        "Sed euismod, nunc ut laoreet dictum, massa sapien tempor urna, vitae fermentum lorem justo nec risus. Praesent dictum, velit non tincidunt vehicula, urna dolor porta ligula.",
                                        "Vivamus suscipit tortor eget felis porttitor volutpat. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus."],
                               fuente: "[Publicación · año · enlace]" },
  ...
  "video-clitoris":          { titulo: "El clítoris entero, en 3 minutos",                  meta: "vídeo · 3:10",     tipo: "video",    pantalla: "contenido-video",    img: "assets/imagen1_panel_2_mejorado.png",
                               autor: "Autor", autoria: { nombre: "Nombre de la autora", rol: "Sexóloga · colegiada nº 0000" },
                               descripcion: "La mayor parte no se ve desde fuera. Qué hay debajo, cómo está conectado y por qué cambia bastante las cosas saberlo.",
                               fuente: "[Publicación · año · enlace]" },
  ...
  "podcast-yo-tampoco":      { titulo: "Yo tampoco sabía",                                  meta: "podcast · 38 min", tipo: "podcast",  pantalla: "contenido-podcast",  img: "assets/imagen1_panel_6_mejorado.png",
                               autor: "Autor", autoria: { nombre: "Nombre de la autora", rol: "Sexóloga · colegiada nº 0000" },
                               descripcion: "Una conversación sobre lo que nadie nos explicó a tiempo, y sobre cómo se aprende de verdad cuando ya eres adulta.",
                               fuente: "[Publicación · año · enlace]" },
