...
- **Usuario que no responde nada en el onboarding.** Ya resuelto: el resumen se salta. Falta definir qué contenido ve en la home alguien de quien no sabemos nada, porque ahora mismo la home de alguien que hace el acceso y alguien que no lo hace es identico, por falta de tiempo se hizo asi, pero para la demo estaria bien para ensenar la personalizacion.
